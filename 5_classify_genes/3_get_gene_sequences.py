...
for cluster in cluster_member_gene:
    ...
    curr_ref_file = os.path.join("/lustre/scratch118/infgen/team216/gh11/e_coli_collections/poppunk/new_roary", cluster, "mode_pan_genome_reference.fa")
...
## run interpro-scan - from the prot directory
# for f in *.fa;
