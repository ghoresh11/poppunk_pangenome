...
fasta_file = "corrected_pan_genome_reference_prot.fa"
gff_file = "interproscan_results.gff"
...
print("Generating a new file: %s" %(gff_file.replace(".fa_result",".csv")))
with open(gff_file.replace(".gff",".csv"),"w") as out:
